...
const TestimonialCard = ({ quote, name, branch }: { quote: string; name: string; branch: string }) => (
  <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg min-w-[300px] md:min-w-[350px] mx-3 card-hover">
    <Quote className="w-8 h-8 text-primary/30 mb-4" />
    <p className="text-muted-foreground leading-relaxed mb-6 text-sm md:text-base">
      {quote}
    </p>
    <Quote className="w-8 h-8 text-primary/30 ml-auto mb-4 rotate-180" />
